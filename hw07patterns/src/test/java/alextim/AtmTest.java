...
import com.alextim.atm.memento.Caretaker;
...
public class AtmTest {
    ...
    @BeforeEach
    void setUp() {
        atm = new SimpleAtm("Spb", atm ->atm.putDeposit(Rub100, 1));
    }
    ...
    public void putDepositTest() {
        ...
        Assertions.assertEquals(46100, atm.getBalance());
    }
    ...
    public void resetTest() {
        ...
        Assertions.assertEquals(100, atm.getBalance());
    }
    ...
    public void saveStateTest() {
        ...
        Caretaker.putMemento("key1", ((MementoStorable) atm).saveState());

        atm.putDeposit(Rub1000, 3);
        atm.putDeposit(Rub100, 8);

        ((MementoStorable) atm).restoreState(Caretaker.getMemento("key1"));

        Assertions.assertEquals(11500, atm.getBalance());
    }
}
